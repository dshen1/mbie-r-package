...
install.packages("P:/R/libraries/AAA TEST LIBRARIES/mbie_0.9.2.zip", repos = NULL, lib = "P:/R/libraries/AAA TEST LIBRARIES")
...
# install.packages("P:/OTSP/data-infrastructure/archive/mbie_0.9.2.zip",repos = NULL,lib = "P:/R/libraries/3.1.2-20150624")
############################################################################
